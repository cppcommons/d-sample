...
struct os_address_t : public os_object_t
{
};
struct os_array_t : public os_object_t
{
};
struct os_integer_t : public os_object_t
{
};
struct os_string_t : public os_object_t
{
};
typedef os_object_t *os_object;
typedef os_address_t *os_address;
typedef os_array_t *os_array;
typedef os_integer_t *os_integer;
typedef os_string_t *os_string;
