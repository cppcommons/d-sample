...
extern os_handle os_get_value(os_handle array, os_size_t index);
...
extern void *os_get_address(os_handle array_or_value, os_size_t index);
...
extern long long os_get_integer(os_handle array_or_value, os_size_t index);
...
extern const char *os_get_string(os_handle array_or_value, os_size_t index);
extern const char *os_get_string2(os_handle array_or_value, os_size_t index, os_size_t *len);
